...
export class IndividualDetailSection extends Component {
    ...
    renderDisplay() {
        ...
        // let firstName = this.props.details?.firstName || "";
        let lastName = this.props.details ? this.props.details.lastName : ""; // add lastName
        ...
        return (
            <div className='row'>
                <div className="ui sixteen wide column">
                    <React.Fragment>
                        <p>NameTest: {firstName} {lastName}</p> { /* add lastname and concact */}
                        <p>Email: {email}</p>
                        <p>Phone: {phone}</p>
                    </React.Fragment>
